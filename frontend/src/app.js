        ...
        <div class="execution-flow">
          ...
          `).join('') : `
            ...
            <div class="node-item">
              ...
              <span class="chip chip-success">13 ms</span>
            </div>
          `}
        </div>
      </div>
...
function renderAdminTab() {
  return `
    <div class="page-header">
      <div>
        <h1 class="page-title">Settings & Technical Observability</h1>
        <p class="page-subtitle">FastMCP server status, token metrics, security guardrails, and audit stream</p>
      </div>
    </div>
    ...
    <div class="kpi-grid">
      <div class="kpi-card">
        ...
        <div class="kpi-subtext" style="color:#059669">Status: ONLINE</div>
      </div>

      <div class="kpi-card">
        <div class="kpi-title">Total LLM Tokens Used</div>
        <div class="kpi-value">${state.telemetry.total_llm_tokens_used || 148520}</div>
        <div class="kpi-subtext">Est Cost: $${state.telemetry.total_estimated_cost_usd || 0.297}</div>
      </div>

      <div class="kpi-card">
        <div class="kpi-title">Guardrails Security</div>
        <div class="kpi-value" style="color:#059669">ACTIVE</div>
        <div class="kpi-subtext">PII Redaction & SQLi Check</div>
      </div>
